...
$(document).ready(function (){
	...
	//Swedish
	train("Svenska substantiv och adjektiv är minskat i två kön och två fall, samt nummer. De två fallen är nominativ och genitiv. Nominativ är ordlistan formen medan genitiv suffix är -er, identisk med den i engelska. Svenska substantiv tillhör en av två könen: uter (också vanligt kön) eller neutrum, vilket också bestämma deklinationer av adjektiv. Till exempel är ordet fisk en uter substantiv och kan ha följande former. Som i andra germanska språk finns bestämda och obestämda artiklar, men ange bestämd form av ett substantiv sker främst av ett suffix som varierar", 'swedish');
	train("De separata artiklar sv / Ett och den / det används för att göra mer subtila variationer av mening och är en del av ett ganska komplext system för att fastställa definitiveness. Artiklarna används för att lägga till en extra dimension till detta system och de slutgiltiga artiklar fördubblas också som demonstrativa pronomen, och kan specificeras ytterligare med adverb såsom where; det. Den fisken och Den där fisken skulle både översätta som att fisk, men med det andra exemplet lägga till en nivå av definitiveness som inte utmärker sig på engelska.", 'swedish');
	train("Vi ger aldrig upp. Vi har legat under även i de andra matcherna, och vi hittar alltid tillbaka, säger förbundskaptenen. Sverige lyfte sig och bara två mål efter i halvtid. Sedan klev Nathalie Hagman fram, gjorde sju mål i andra halvlek och ordnade en svensk seger. Hon är bäst. Hon är bäst. Hon är mirakulöst bra där ute på kanten. Hon har en guldhandled, säger experten. Matchhjälten Hagman spelade dessutom matchen skadad. i samband med stans 400-årsjubileum blev uppskattad. Nu ska den förhoppningsvis bli en tradition som kommer varje år.", 'swedish');
	train("Den språkliga definitionen av ett svenskt dialekt är en lokal variant som inte har påverkats starkt av standarden språket och som kan spåra en separat utveckling ända tillbaka till fornnordiska. Många av de äkta landsbygds dialekter, såsom de i Orsa i Dalarna eller Närpes i Österbotten, har mycket tydliga fonetiska och grammatiska funktioner, såsom pluralformer av verb eller arkaiska fall böjningar. Dessa dialekter kan vara nära-obegripligt för de flesta svenskar, och de flesta av deras högtalare är också flytande i Standard .", 'swedish');
	train("Vissa filmer är kända för att vara baserad på en sann historia. Dessa typer av filmer är mycket intressant eftersom de faktiskt hände. Den enda anledningen till att de anses inte vara en icke-fiction-filmen är att regissören eller författare kommer att lägga några scener som inte hända, eller ändra några fakta runt så filmen är mer tilltalande för massorna. har tillsatt en pension provision speciellt att titta på vad du kan göra för att lösa. Alla som bor i kommunen och besökare får chans att mötas och ta del av kulturutbudet", 'swedish');
	train("Genom att ha redo dina resehandlingar, organiserar vad du kommer att bära. Först, beroende på de dagar resan, välja storlek på resväskan, välj sedan dina kläder enligt klimatet; Glöm inte att ta med din kamera eller videokamera för att spara oförglömliga stunder av resan. Hej, mitt namn. Jag har år och är gift med två barn. Vi vill ta tillvara på alla de goda erfarenheterna och senare i vinter hoppas vi kunna presentera ett mer detaljerat program. Enskilda föreningar, eller aktörer runt om i kommunen som är intresserade av att vara med och arrangera något får gärna kontakta oss, säger ", 'swedish');
	train("Ellen örnen först misstänkte att hon behövde glasögon dagen som hon svepte ner från himlen och tog en liten gräsmatta stol att bära tillbaka till sina hungriga barn. När hon kom tillbaka till sitt bo, som ligger högt uppe på en klippa, hennes äldsta son sa något sarkastiskt, En annan gräsmatta stol till frukost. Precis vad vi behöver. Hennes man, var mer förlåtande. Han plockade försiktigt upp gräsmattan stol med sin näbb och flyttade över den till den platta, baksida delen av boet. Sedan satte han sig i gräsmatta stol, knäppte vingar bekvämt bakom huvudet, och lägga tillbaka.", 'swedish');
	train("En person fick föras till sjukhus med rökskador i samband med en brand på ett asylboende i Hällevik utanför Sölvesborg i Blekinge. Larmet gick strax innan halv tre på söndagseftermiddagen och släckningsarbetet kom snabbt igång. Branden ska ha begränsats till ett slutet utrymme, rapporterar lokala medier. Samtliga boende kunde snabbt ta sig ut ur anläggningen — som ägs av nöjesprofilen  Karlsson och har plats för personer.De flesta har kunnat återvända in till sina bostäder. Resten tar Migrationsverket hand om när det kommer till inkvartering, säger  Jeppsson som är pressinformatör på Blekingepolisen.", 'swedish');
	train("Även denna terminologi och dess definitioner sedan länge upprättat bland lingvister, de flesta svenskar är omedvetna om skillnaden och dess historiska bakgrund, och hänvisar ofta till de regionala sorter som dialekter. I en opinionsundersökning som nyligen genomfördes av HUI, attityder svenskarna till användningen av vissa sorter av säljare visade att 54% trodde att rikssvenska var sorten de skulle föredra att höra när man talar med försäljare via telefon, även om flera dialekter såsom Gotländska eller skånska lämnades som alternativ i omröstningen.", 'swedish');
	train("Den som trodde att myggplågan var över för den här säsongen har alltså räknat fel. Myggorna finns i ett stort antal arter — varav omkring etthundra är så kallade stickmyggor och alla har sin egen levnadssäsong. Enligt Christer Erséus har en torr sommar, följd av mycket regn och nya värmeböljor, varit en perfekt miljö för att nya stickmyggor kan se dagens ljus under ett antal veckor till.Enligt SMHI kommer de senaste dagarnas värmebölja nu att mattas av något. Men efter regn i början av veckan visar prognoserna sol och upp till 19 grader i stora delar av Svealand och Götaland.", 'swedish');
	
	//Finnish
	train("Tämä sivusto on suunniteltu lähtökohtana ihmisille, jotka haluavat oppia lisää suomea.Linkit vasemmalla sisältävät Englanti-suomi käännökset sekä muuta hyödyllistä tietoa Suomen kieli. Kun jotkut käännökset suomeksi, foneettinen ääntäminen on suluissa. Tämä voi olla hyödyllistä, koska opas korjata ääntämistä, mutta se on suositeltavaa oppia eri yksittäisiä ääniä, jotka muodostavat kunkin sanan tai lauseen.Ääntäminen keskustelualueen yläosassa voi auttaa tässä. Suomi on Pohjois-Euroopan maassa neljä vuodenaikaa vaativankin, ei maa massaturismin.", 'finnish');
	train("Kesäkausi Helsingissä talvella hiihto Lapin ja muutaman tapahtumia ympäri vuoden temp tarpeeksi ihmisiä tekemään sitä väkeä, muuten voit nauttia tilaa ja hiljaisuutta puhdasta pohjoisen luonnon. Talvikuukausina voit hiihtoloma tai käydä Santa Claus ja kestää poro kiertue. Kesä tarjoaa sinulle laajan valikoiman aktiivisuutta vaellus kaupunkien vapaapäiviä, tai voit vain rentoutua piilotettu kesämökin saunan lähellä järveä. Lisäksi Manner kanssa laajoja metsiä ja tuhansien järvien erotetaan muutaman maatalous- ja kaupunkialueiden, Itämeren laajaa saaristot tarjoaa runsaasti mahdollisuuksia purjehdusta ja kalastusta.", 'finnish');
	train("Päivystävän palomestarin mukaan viranomaisilla ei ole vielä käsitystä siitä, kumpi ajoneuvo oli päätynyt vastaantulevien kaistalle. Poliisi tutkii tapausta. Poliisin mukaan henkilöauto oli tullut pohjoisen suunnasta ja törmännyt vastaan tulleeseen raskaaseen ajoneuvoyhdistelmään valtatie noin metriä Vehniäntiestä pohjoiseen päin. Henkilöautossa oli kuljettajan lisäksi kaksi matkustajaa. Kaikki henkilöautossa olleet henkilöt menehtyivät. Yhdistelmän vetoauton kuljettaja loukkaantui lievästi. Tie on poikki toistaiseksi ja poliisi ohjaa liikennettä kiertotien kautta.", 'finnish');
	train("Tampereen keskusvirastotalon ikkuna rikottiin sunnuntain vastaisena yönä. Aamulehteen lähetetyssä valokuvassa näkyy, että yksi virastotalon julkisivun isoista lasi-ikkunoista on säpäleinä.Poliisin tilannekeskuksesta kerrotaan, että poliisi sai vahingonteosta ilmoituksen viime yönä kahden jälkeen. Ilmoittaja kertoi, että virastotalon ikkuna oli pistetty sisään. Ikkunan oli silminnäkijän mukaan rikkonut mieshenkilö.Poliisi kävi yöllä paikalla, mutta tekijää ei löytynyt.Lasi sai olla rikki ja sirpaleet jalkakäytävällä koko sunnuntain. Valokuva on otettu iltaseitsemän jälkeen sunnuntaina", 'finnish');
	train("Eksoottinen lintuhämähäkki eli tarantula karkasi eilen terraariostaan kerrostaloasunnossa Pirkkalan Suupankujalla. Hämähäkkiä ei ole löytynyt.Pelastuslaitos sai asiasta hälytyksen tänään sunnuntaina kahden jälkeen. Palomestari Pauli Keskinen kertoo, että asukkaat tarvitsivat apua hämähäkin etsinnöissä. Hän ei itse käynyt paikalla, mutta ilmeisesti kaappeja oli pitänyt siirtää tai purkaa.Hämähäkki oli nähty yhdessä huoneessa ja se oli mennyt jonkin kaapin taakse, Keskinen kertoo.Hämähäkkiä ei kuitenkaan löytynyt.Muiden ihmisten ei tarvitse huolestua tilanteesta, sillä tarantula liikuskelee tiettävästi.", 'finnish');
	train("yhä asunnossa. Hämähäkki on myrkyllinen, mutta sen purema ei ole useimmille ihmisille hengenvaarallinen. Omistajan arvion mukaan tämän kyseisen hämähäkin purema vastaa noin kolmea ampiaisenpistoa, Keskinen kertoo. Lintuhämähäkkejä on Wikipedian mukaan noin 85 sukua ja arviolta 900 lajia. Muutamaa sukua lukuunottamatta ne ovat ihmiselle melko vaarattomia. Mikäli lintuhämähäkki pääsee puremaan ihmistä, on reaktio usein samankaltainen kuin ampiaisen pistossa. Mitäs tähän sanoo nämä elukoiden suojelijat? Lintuhämähäkki ei kuulu suomalaiseen eläinlajistoon joten miksi niitä pitää tänne haalia? Ei muuta kuin saappaankorkoa kun tuollaisen elukan tapaa.", 'finnish');
	train("Eikä näitä elukoista ole tarkoitettu asumaan lasikaapeissa vaan niiden tulee vapaasti juoksennella kotimaassaan missä niitä on luonnostaan. Mulle olisi hengenvaarallinen kun olen ampiaisenpistoille allerginen. Olisi kyllä kiva ettei tuollaisia myrkyllisiä lemmikkejä pidettäisi kun ne kerran karkailevat.  listannut tämän vuoden puhutuimmat aiheet yhteisöpalvelussa. Listauksesta kertoo sanomalehti.Lista tehtiin laskemalla, kuinka usein tietty aihe esiintyy käyttäjien julkaisuissa. Facebookin mukaan sisältöä analysoitiin anonyymisti.Vuoden kuumimmat puheenaiheet ovat pääosin isoja uutis- tai urheilutapahtumia.", 'finnish');
	train("Rantaperkiön Iskulla oli sunnuntaina aihetta ainakin kolmenlaiseen lentopallojuhlaan. Tamperelaisseura otti miesten Mestaruusliigassa kolme sarjapistettä kaadettuaan kuopiolaisen Leka Volleyn, ja Tuomas Tihinen saavutti . pisteensä liigassa. Lisäksi seura saavutti viime kauden kokonaispistemääränsä jo ennen kuluvan kauden puoliväliä.Isku henkilöityy Tihiseen, ja seuraa on vaikea kuvitella ilman häntä. Pelistä voi sanoa, ettemme me olleet huonoja, mutta paremmille hävittiin, sanoi Lekan valmentaja Hakala.Tihinen oli ottelun tehokkain pisteellä. Hakkurit Iskun Samuli Kaislasalo ja Lekan Mart Tiisaar kokosivat pistettä. Isku sai peräti pistettä torjunnalla.", 'finnish');
	train("Ilveksen pelaajat saivat sunnuntaina kotiin viemisiksi hienot retropaidat, valmennus sarjataulukkoon kolme pistettä ja seurajohto niin hyvät kokemukset, että Koulukadun tapahtumalle voi huoletta povata jatkoa jo ensi kaudelle.Kerran kaudessa voisi olla sopiva tahti paikallisottelulle. Mukavaa oli, tuli voitto, oli hyvä sääkin. Uran ensimmäinen peli ulkona ei olisi voinut paremmin sujua, sanoi 2–1-voiton Tapparasta torjunut maalivahti Nico Viksten.Ulkona pelaaminen tuo etenkin maalivahdeille omat haasteensa. Siihen nähden myös uransa ensimmäisen ulkoilmaottelun pelannut Dominik Hrachovina saa hänkin olla tyytyväinen. Loistotorjuntoja tuli hänellekin.", 'finnish');
	train("Pääministeri Stubbin (kok) ja kahden keskustan kansanedustajan välille on kehkeytynyt kipakka sananvaihto Suomen Venäjä-suhteista.Stubb moitti Ylen Pääministerin haastattelutunnilla eräiden keskustalaisten haluja irrottaa Suomea EU:n yhteisestä pakotepolitiikasta. Hän sanoi tällaisen vievän Suomea harmaalle vyöhykkeelle Neuvostoliiton aikojen tyyliin ja nimesi Lehtomäen ja Kääriäisen tällaisen linjan kannattajiksi.Minun mielestäni tämä ei ole turvallista ulko- ja turvallisuuspolitiikkaa, ja se antaa väärän viestin suomalaisille ja myös meidän läntisille liittolaisille ja kumppaneille, Stubb sanoi Ylen Pääministerin haastattelutunnilla.", 'finnish');
